                ...
                <Row>
                    <Col mx="auto" className="text-center" style={{color:"#5b785b"}}>
                        <Alert style={{backgroundColor:"#f6fff6"}}>
                            ...
                            <span style={{fontSize:"14px", fontWeight:'300'}}> <a href="https://facebook.com/groups/224616649206338/" target="_blank">ผู้ดูแลกลุ่ม สอบครูผู้ช่วย เอกคอมพิวเตอร์ (นายโรบอท.com)</a></span>
                            {/* &nbsp;&nbsp; หรือ &nbsp;&nbsp;
